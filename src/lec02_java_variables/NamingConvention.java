...
public class NamingConvention {
	...
	// public is an access modifier, int is the type of variable, houseNumber is the
	// name of the variable
	public int houseNumber = 652; // variable initialized
	public String avenue_name; // varibale declared

	// Constant names are written with all upper case letters with words separated
	// by underscores
