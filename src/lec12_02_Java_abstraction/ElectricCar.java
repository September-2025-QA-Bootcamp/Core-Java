...
public abstract class ElectricCar extends FlyingCar implements HoverCar, Rocket {
	...
	// we can also create parameterized method, return type method inside an abstract class
	...
	// Default methods are allowed only inside interfaces, not in abstract class
	/*
